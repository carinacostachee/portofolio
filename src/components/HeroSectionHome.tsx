  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-rose-100 via-white to-rose-200 overflow-hidden ">
      <div className="grid grid-cols-4">
        <div className=" flex flex-col justify-start items-start gap-4 col-span-1 ml-10 mt-4">
          <div className="flex flex-col items-center gap-1">
            <img
              src="/photos/Lolita.png"
              alt="Lolita postacard"
              className="w-14 sm:w-40 h-auto"
            />
            <div className="font-inconsolata text-black font-bold text-[5px] sm:text-sm ">
              Lolita_postcard.png
            </div>
          </div>
          <div className="flex flex-col items-center gap-1">
        ...
        <div className="col-span-3 flex flex-col lg:flex-row justify-center items-center min-h-screen gap-10 p-4 z-12">
